...
{
    /// <inheritdoc />
    public partial class _19012025Migration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Actors = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Rated = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReleasedDate = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Writer = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ...
                    ImdbRating = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RatingNumber = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ReleasedDate = table.Column<DateTime>(type: "datetime2", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppTemporadas_AppSeries_IdSerie",
                        column: x => x.IdSerie,
                        principalTable: "AppSeries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Duration = table.Column<TimeSpan>(type: "time", maxLength: 128, nullable: false),
                    Synopsis = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ReleasedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Director = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Writer = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppEpisodios_AppTemporadas_IdSeason",
                        column: x => x.IdSeason,
