...
{
    [DbContext(typeof(BBBBFLIXDbContext))]
    [Migration("20250717233246_17072025 agregado dbset en dbcontext")]
    partial class _17072025agregadodbsetendbcontext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BBBBFLIX.Monitoring.APIMonitoring", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("APIMonitorings");
                });

            modelBuilder.Entity("BBBBFLIX.Notifications.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBBBFLIX.Series.Episode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BBBBFLIX.Series.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBBBFLIX.Series.Season", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBBBFLIX.Series.Serie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBBBFLIX.WatchLists.Watchlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBBBFLIX.Series.Episode", b =>
                {
                    b.HasOne("BBBBFLIX.Series.Season", "Season")
                        .WithMany("Episodes")
            ...
            modelBuilder.Entity("BBBBFLIX.Series.Rating", b =>
                {
                    b.HasOne("BBBBFLIX.Series.Serie", "Serie")
                        .WithMany("Ratings")
            ...
            modelBuilder.Entity("BBBBFLIX.Series.Serie", b =>
                {
                    b.HasOne("BBBBFLIX.WatchLists.Watchlist", null)
                        .WithMany("Series")
